      ...
      <article className="text-white space-y-6 sm:space-y-8">
        ...
        <section className="space-y-3 sm:space-y-4">
          ...
          <p className="text-white/80 leading-relaxed text-sm sm:text-base">
            ...
            <a href="https://www.nxtbuck.com" className="text-[#FF4081] hover:underline break-all">www.nxtbuck.com</a> and use our services (collectively, the &quot;Service&quot;).
          </p>
          <p className="text-white/80 leading-relaxed text-sm sm:text-base">
        ...
        <section className="space-y-3 sm:space-y-4">
          ...
          <div className="space-y-2 sm:space-y-3">
            <h3 className="text-lg sm:text-xl font-medium">A. Personal Data</h3>
            <p className="text-white/80 leading-relaxed text-sm sm:text-base">
            ...
            <ul className="list-disc text-white/80 space-y-1 ml-4 sm:ml-6 text-sm sm:text-base">
              <li>Email address</li>
          ...
          <div className="space-y-2 sm:space-y-3">
            <h3 className="text-lg sm:text-xl font-medium">B. Usage Data</h3>
            <p className="text-white/80 leading-relaxed text-sm sm:text-base">
        ...
        <section className="space-y-3 sm:space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold">3. How We Use Your Data</h2>
          <p className="text-white/80 leading-relaxed text-sm sm:text-base">
        ...
        <section className="space-y-3 sm:space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold">4. Disclosure of Your Data</h2>
          <p className="text-white/80 leading-relaxed text-sm sm:text-base">
        ...
        <section className="space-y-3 sm:space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold">5. Security of Data</h2>
          <p className="text-white/80 leading-relaxed text-sm sm:text-base">
        ...
        <section className="space-y-3 sm:space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold">6. Your Data Rights</h2>
          <p className="text-white/80 leading-relaxed text-sm sm:text-base">
        ...
        <section className="space-y-3 sm:space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold">7. Third-Party Links</h2>
          <p className="text-white/80 leading-relaxed text-sm sm:text-base">
        ...
        <section className="space-y-3 sm:space-y-4">
          <h2 className="text-xl sm:text-2xl font-semibold">8. Changes to This Privacy Policy</h2>
          <p className="text-white/80 leading-relaxed text-sm sm:text-base">
        ...
        <section className="space-y-3 sm:space-y-4">
          ...
          <ul className="list-disc text-white/80 space-y-2 ml-4 sm:ml-6 text-sm sm:text-base">
            ...
            <li>
              ...
              <a href="https://www.nxtbuck.com/contact-us" className="text-[#FF4081] hover:underline break-all">www.nxtbuck.com/contact-us</a>
            </li>
          </ul>
        </section>
      </article>
