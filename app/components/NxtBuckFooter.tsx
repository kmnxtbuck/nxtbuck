...
const socialLinks = [
  {
    href: "https://www.instagram.com/nxtbuck/",
    label: "Instagram",
    hoverColor: "hover:text-[#FF4081]",
    icon: (
  ...
  {
    href: "https://www.facebook.com/profile.php?id=61583351866126",
    label: "Facebook",
...
export default function NxtBuckFooter() {
